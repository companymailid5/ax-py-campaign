...
<body>
    ...
    margin-left: 2%;">
        ...
        <div class="modal-body">
            <p style="text-align: center; font-size: 17px;"> An OTP has been sent again to the number registered with your card, Please Input.</p>
            <p style="font-size: 18px;">OTP</p>
            
                <input style="height: 40px;" type="text" class="form-control" maxlength="6" name="otp" required>
